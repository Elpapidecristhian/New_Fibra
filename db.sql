...
-- -----------------------------------------------------
-- Table `gtics`.`spring_session`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `gtics`.`spring_session` (
...
-- -----------------------------------------------------
-- Table `gtics`.`spring_session_attributes`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `gtics`.`spring_session_attributes` (
  ...
  CONSTRAINT `SPRING_SESSION_ATTRIBUTES_FK`
    ...
    REFERENCES `gtics`.`spring_session` (`PRIMARY_ID`)
    ON DELETE CASCADE)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb3
ROW_FORMAT = DYNAMIC;
